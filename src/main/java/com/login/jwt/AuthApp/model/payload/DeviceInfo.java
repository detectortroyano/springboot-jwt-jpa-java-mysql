package com.login.jwt.AuthApp.model.payload;

import com.login.jwt.AuthApp.model.DeviceType;
import com.login.jwt.AuthApp.validation.annotation.NullOrNotBlank;
